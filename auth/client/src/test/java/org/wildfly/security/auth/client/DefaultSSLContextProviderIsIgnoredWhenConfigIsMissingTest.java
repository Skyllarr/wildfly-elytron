...
public class DefaultSSLContextProviderIsIgnoredWhenConfigIsMissingTest {
    ...
    public void defaultSSLContextProviderIsIgnoredWhenConfigIsMissingTest() {
        ...
        Assert.assertNotEquals(ElytronClientDefaultSSLContextProvider.class.getSimpleName(), defaultSSLContext.getProvider().getName()); // different provider was used since no default SSL context configured in Elytron client
