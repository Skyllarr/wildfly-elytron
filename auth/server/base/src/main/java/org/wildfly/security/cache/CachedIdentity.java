...
public final class CachedIdentity implements Serializable {
     ...
     *
     * @return the roles associated with the cached identity. The name should never be null, as it will be used to re-create the identity when necessary (not {@code null})
     */
