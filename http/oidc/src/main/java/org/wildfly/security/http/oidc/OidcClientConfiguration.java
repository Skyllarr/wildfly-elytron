...
public class OidcClientConfiguration {
    ...
    protected void resolveUrls(OidcClientUriBuilder authUrlBuilder) {
        ...
        authUrl = OidcClientUriBuilder.fromUri(login);
        ...
        logoutUrl = OidcClientUriBuilder.fromUri(authUrlBuilder.clone().path(ServiceUrlConstants.TOKEN_SERVICE_LOGOUT_PATH).build(getRealm()).toString());
