...
public class ServerAuthenticationContextCallbackTest {
    ...
    @BeforeClass
    public static void testSkipCertVerificationProp() throws Exception {
    ...
    public void testWithSkipCertificateVerificationProp() throws GeneralSecurityException, IOException, UnsupportedCallbackException {
        ...
        SaslServer saslServerWithSkipCertificateProp = factory.createSaslServer("EXTERNAL", "test", "localhost", setProps("org.wildfly.sasl.skip-certificate-verification"), callbackHandler);
        try {
    ...
    private static Path getRootPath() throws Exception {
        rootPath = Paths.get(ServerAuthenticationContextCallbackTest.class.getResource(File.separator).toURI())
